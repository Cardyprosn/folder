															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">CardyPro</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Salut&ensp;<?php echo $_SESSION['username_T']; ?></h2>
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Nous sommes trés heureux qu'une nouvelle personne est rejoint notre communauté, nous vous envoyons cette email suite a votre demande d'inscription, et pour nous assurer qu'il s'agit bien de vous. <br> 
																			Pour cela il n-ya rien de plus simple que de nous rensigner le code de verification ou de cliquer sur le boutton qui serra si contre et comme ça, la verification sera automatique.
												...
												<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<br>
															<span><strong><?php echo $_SESSION['vcode']; ?></strong></span>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:135%;" href="#" target="_blank">Oui je suis bien&ensp;<?php echo $_SESSION['username_T']; ?></a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					-->
																					<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Message de <strong>
																						CardyPro
																					</strong></h3>
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																						Si vous n'êtes pas au courant de cette activité nous vous prions de negliger tout simplement le message .
																						<br>
																						<br>
																						<span style="font-size: 10px;"> <strong>
																							Cardypro
																						</strong>vous remmercie de votre aimmable attention</span>
																					</div>
																				</td>
																			</tr>
																		</table>
